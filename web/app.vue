                    ...
                    <nav class="relative mx-auto flex max-w-7xl items-center justify-between px-6" aria-label="Global">
                        <div class="flex flex-1 items-center">
                            <div class="flex w-full items-center justify-between md:w-auto">
                                <a href="#">
                                    <span class="sr-only">Nexabase</span>
                        ...
                        <div class="lg:grid lg:grid-cols-2 lg:gap-8">
                            <div class="mx-auto max-w-md px-6 sm:max-w-2xl sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                                <div class="lg:py-24">
                                    ...
                                    <h1 class="mt-4 text-4xl font-bold tracking-tight text-white sm:mt-5 lg:mt-6">
                                        <span class="block text-4xl sm:text-8xl">
                                            Nexabase
                                        </span>

                                        <span class="text-4xl sm:text-5xl block bg-gradient-to-r from-teal-200 to-cyan-400 bg-clip-text pb-3 text-transparent sm:pb-5">
                                            Your Premium Nexa DX
                                        </span>
                                    </h1>

                                    <p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                                        Build and ship your decentralized apps faster!
